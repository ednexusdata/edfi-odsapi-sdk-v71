# EdFi.OdsApi.Sdk.v71.Apis.All.CteProgramServiceDescriptorsApi
...
> List&lt;EdFiCteProgramServiceDescriptor&gt; GetCTEProgramServiceDescriptors (int offset = null, int limit = null, long minChangeVersion = null, long maxChangeVersion = null, bool totalCount = null, int cteProgramServiceDescriptorId = null, bool useSnapshot = null)
...
namespace Example
{
    public class GetCTEProgramServiceDescriptorsExample
    {
        public static void Main()
        {
            ...
            {
                // Retrieves specific resources using the resource's property values (using the \"Get\" pattern).
                List<EdFiCteProgramServiceDescriptor> result = apiInstance.GetCTEProgramServiceDescriptors(offset, limit, minChangeVersion, maxChangeVersion, totalCount, cteProgramServiceDescriptorId, useSnapshot);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
...
{
    // Retrieves specific resources using the resource's property values (using the \"Get\" pattern).
    ApiResponse<List<EdFiCteProgramServiceDescriptor>> response = apiInstance.GetCTEProgramServiceDescriptorsWithHttpInfo(offset, limit, minChangeVersion, maxChangeVersion, totalCount, cteProgramServiceDescriptorId, useSnapshot);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
