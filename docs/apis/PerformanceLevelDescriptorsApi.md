# EdFi.OdsApi.Sdk.v71.Apis.All.PerformanceLevelDescriptorsApi
...
> List&lt;EdFiPerformanceLevelDescriptor&gt; GetPerformanceLevelDescriptors (int offset = null, int limit = null, long minChangeVersion = null, long maxChangeVersion = null, bool totalCount = null, int performanceLevelDescriptorId = null, bool useSnapshot = null)
...
namespace Example
{
    public class GetPerformanceLevelDescriptorsExample
    {
        public static void Main()
        {
            ...
            {
                // Retrieves specific resources using the resource's property values (using the \"Get\" pattern).
                List<EdFiPerformanceLevelDescriptor> result = apiInstance.GetPerformanceLevelDescriptors(offset, limit, minChangeVersion, maxChangeVersion, totalCount, performanceLevelDescriptorId, useSnapshot);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
...
{
    // Retrieves specific resources using the resource's property values (using the \"Get\" pattern).
    ApiResponse<List<EdFiPerformanceLevelDescriptor>> response = apiInstance.GetPerformanceLevelDescriptorsWithHttpInfo(offset, limit, minChangeVersion, maxChangeVersion, totalCount, performanceLevelDescriptorId, useSnapshot);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
