# EdFi.OdsApi.Sdk.v71.Apis.All.TelephoneNumberTypeDescriptorsApi
...
> List&lt;EdFiTelephoneNumberTypeDescriptor&gt; GetTelephoneNumberTypeDescriptors (int offset = null, int limit = null, long minChangeVersion = null, long maxChangeVersion = null, bool totalCount = null, int telephoneNumberTypeDescriptorId = null, bool useSnapshot = null)
...
namespace Example
{
    public class GetTelephoneNumberTypeDescriptorsExample
    {
        public static void Main()
        {
            ...
            {
                // Retrieves specific resources using the resource's property values (using the \"Get\" pattern).
                List<EdFiTelephoneNumberTypeDescriptor> result = apiInstance.GetTelephoneNumberTypeDescriptors(offset, limit, minChangeVersion, maxChangeVersion, totalCount, telephoneNumberTypeDescriptorId, useSnapshot);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
...
{
    // Retrieves specific resources using the resource's property values (using the \"Get\" pattern).
    ApiResponse<List<EdFiTelephoneNumberTypeDescriptor>> response = apiInstance.GetTelephoneNumberTypeDescriptorsWithHttpInfo(offset, limit, minChangeVersion, maxChangeVersion, totalCount, telephoneNumberTypeDescriptorId, useSnapshot);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
