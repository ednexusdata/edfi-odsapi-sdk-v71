# EdFi.OdsApi.Sdk.v71.Apis.All.DisabilityDesignationDescriptorsApi
...
> List&lt;EdFiDisabilityDesignationDescriptor&gt; GetDisabilityDesignationDescriptors (int offset = null, int limit = null, long minChangeVersion = null, long maxChangeVersion = null, bool totalCount = null, int disabilityDesignationDescriptorId = null, bool useSnapshot = null)
...
namespace Example
{
    public class GetDisabilityDesignationDescriptorsExample
    {
        public static void Main()
        {
            ...
            {
                // Retrieves specific resources using the resource's property values (using the \"Get\" pattern).
                List<EdFiDisabilityDesignationDescriptor> result = apiInstance.GetDisabilityDesignationDescriptors(offset, limit, minChangeVersion, maxChangeVersion, totalCount, disabilityDesignationDescriptorId, useSnapshot);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
...
{
    // Retrieves specific resources using the resource's property values (using the \"Get\" pattern).
    ApiResponse<List<EdFiDisabilityDesignationDescriptor>> response = apiInstance.GetDisabilityDesignationDescriptorsWithHttpInfo(offset, limit, minChangeVersion, maxChangeVersion, totalCount, disabilityDesignationDescriptorId, useSnapshot);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
