# EdFi.OdsApi.Sdk.v71.Apis.All.DisciplineActionsApi
...
namespace Example
{
    public class GetDisciplineActionsExample
    {
        public static void Main()
        {
            ...
            var responsibilitySchoolId = 789L;  // long | The identifier assigned to a school. (optional) 
            var assignmentSchoolId = 789L;  // long | The identifier assigned to a school. (optional) 
...
| **responsibilitySchoolId** | **long** | The identifier assigned to a school. | [optional]  |
| **assignmentSchoolId** | **long** | The identifier assigned to a school. | [optional]  |
