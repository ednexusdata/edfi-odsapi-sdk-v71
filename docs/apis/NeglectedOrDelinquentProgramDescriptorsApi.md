# EdFi.OdsApi.Sdk.v71.Apis.All.NeglectedOrDelinquentProgramDescriptorsApi
...
> List&lt;EdFiNeglectedOrDelinquentProgramDescriptor&gt; GetNeglectedOrDelinquentProgramDescriptors (int offset = null, int limit = null, long minChangeVersion = null, long maxChangeVersion = null, bool totalCount = null, int neglectedOrDelinquentProgramDescriptorId = null, bool useSnapshot = null)
...
namespace Example
{
    public class GetNeglectedOrDelinquentProgramDescriptorsExample
    {
        public static void Main()
        {
            ...
            {
                // Retrieves specific resources using the resource's property values (using the \"Get\" pattern).
                List<EdFiNeglectedOrDelinquentProgramDescriptor> result = apiInstance.GetNeglectedOrDelinquentProgramDescriptors(offset, limit, minChangeVersion, maxChangeVersion, totalCount, neglectedOrDelinquentProgramDescriptorId, useSnapshot);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
...
{
    // Retrieves specific resources using the resource's property values (using the \"Get\" pattern).
    ApiResponse<List<EdFiNeglectedOrDelinquentProgramDescriptor>> response = apiInstance.GetNeglectedOrDelinquentProgramDescriptorsWithHttpInfo(offset, limit, minChangeVersion, maxChangeVersion, totalCount, neglectedOrDelinquentProgramDescriptorId, useSnapshot);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
