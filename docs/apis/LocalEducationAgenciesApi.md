# EdFi.OdsApi.Sdk.v71.Apis.All.LocalEducationAgenciesApi
...
namespace Example
{
    public class GetLocalEducationAgenciesExample
    {
        public static void Main()
        {
            ...
            var maxChangeVersion = 789L;  // long | Used in synchronization to set sequence maximum ChangeVersion (optional) 
            var totalCount = false;  // bool | Indicates if the total number of items available should be returned in the 'Total-Count' header of the response.  If set to false, 'Total-Count' header will not be provided. (optional)  (default to false)
            var localEducationAgencyId = 789L;  // long | The identifier assigned to a local education agency. (optional) 
            var educationServiceCenterId = 789L;  // long | The identifier assigned to an education service center. (optional) 
            var parentLocalEducationAgencyId = 789L;  // long | The identifier assigned to a local education agency. (optional) 
...
| **parentLocalEducationAgencyId** | **long** | The identifier assigned to a local education agency. | [optional]  |
