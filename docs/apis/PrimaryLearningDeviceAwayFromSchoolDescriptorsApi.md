# EdFi.OdsApi.Sdk.v71.Apis.All.PrimaryLearningDeviceAwayFromSchoolDescriptorsApi
...
> List&lt;EdFiPrimaryLearningDeviceAwayFromSchoolDescriptor&gt; GetPrimaryLearningDeviceAwayFromSchoolDescriptors (int offset = null, int limit = null, long minChangeVersion = null, long maxChangeVersion = null, bool totalCount = null, int primaryLearningDeviceAwayFromSchoolDescriptorId = null, bool useSnapshot = null)
...
namespace Example
{
    public class GetPrimaryLearningDeviceAwayFromSchoolDescriptorsExample
    {
        public static void Main()
        {
            ...
            {
                // Retrieves specific resources using the resource's property values (using the \"Get\" pattern).
                List<EdFiPrimaryLearningDeviceAwayFromSchoolDescriptor> result = apiInstance.GetPrimaryLearningDeviceAwayFromSchoolDescriptors(offset, limit, minChangeVersion, maxChangeVersion, totalCount, primaryLearningDeviceAwayFromSchoolDescriptorId, useSnapshot);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
...
{
    // Retrieves specific resources using the resource's property values (using the \"Get\" pattern).
    ApiResponse<List<EdFiPrimaryLearningDeviceAwayFromSchoolDescriptor>> response = apiInstance.GetPrimaryLearningDeviceAwayFromSchoolDescriptorsWithHttpInfo(offset, limit, minChangeVersion, maxChangeVersion, totalCount, primaryLearningDeviceAwayFromSchoolDescriptorId, useSnapshot);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
