# EdFi.OdsApi.Sdk.v71.Apis.All.SectionsApi
...
namespace Example
{
    public class GetSectionsExample
    {
        public static void Main()
        {
            ...
            var locationSchoolId = 789L;  // long | The identifier assigned to a school. (optional) 
...
| **locationSchoolId** | **long** | The identifier assigned to a school. | [optional]  |
