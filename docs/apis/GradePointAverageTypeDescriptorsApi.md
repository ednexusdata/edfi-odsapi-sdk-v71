# EdFi.OdsApi.Sdk.v71.Apis.All.GradePointAverageTypeDescriptorsApi
...
> List&lt;EdFiGradePointAverageTypeDescriptor&gt; GetGradePointAverageTypeDescriptors (int offset = null, int limit = null, long minChangeVersion = null, long maxChangeVersion = null, bool totalCount = null, int gradePointAverageTypeDescriptorId = null, bool useSnapshot = null)
...
namespace Example
{
    public class GetGradePointAverageTypeDescriptorsExample
    {
        public static void Main()
        {
            ...
            {
                // Retrieves specific resources using the resource's property values (using the \"Get\" pattern).
                List<EdFiGradePointAverageTypeDescriptor> result = apiInstance.GetGradePointAverageTypeDescriptors(offset, limit, minChangeVersion, maxChangeVersion, totalCount, gradePointAverageTypeDescriptorId, useSnapshot);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
...
{
    // Retrieves specific resources using the resource's property values (using the \"Get\" pattern).
    ApiResponse<List<EdFiGradePointAverageTypeDescriptor>> response = apiInstance.GetGradePointAverageTypeDescriptorsWithHttpInfo(offset, limit, minChangeVersion, maxChangeVersion, totalCount, gradePointAverageTypeDescriptorId, useSnapshot);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
