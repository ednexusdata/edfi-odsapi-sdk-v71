# EdFi.OdsApi.Sdk.v71.Apis.All.LicenseTypeDescriptorsApi
...
> List&lt;EdFiLicenseTypeDescriptor&gt; GetLicenseTypeDescriptors (int offset = null, int limit = null, long minChangeVersion = null, long maxChangeVersion = null, bool totalCount = null, int licenseTypeDescriptorId = null, bool useSnapshot = null)
...
namespace Example
{
    public class GetLicenseTypeDescriptorsExample
    {
        public static void Main()
        {
            ...
            {
                // Retrieves specific resources using the resource's property values (using the \"Get\" pattern).
                List<EdFiLicenseTypeDescriptor> result = apiInstance.GetLicenseTypeDescriptors(offset, limit, minChangeVersion, maxChangeVersion, totalCount, licenseTypeDescriptorId, useSnapshot);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
...
{
    // Retrieves specific resources using the resource's property values (using the \"Get\" pattern).
    ApiResponse<List<EdFiLicenseTypeDescriptor>> response = apiInstance.GetLicenseTypeDescriptorsWithHttpInfo(offset, limit, minChangeVersion, maxChangeVersion, totalCount, licenseTypeDescriptorId, useSnapshot);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
