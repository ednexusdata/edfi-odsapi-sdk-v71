# EdFi.OdsApi.Sdk.v71.Apis.All.CurriculumUsedDescriptorsApi
...
> List&lt;EdFiCurriculumUsedDescriptor&gt; GetCurriculumUsedDescriptors (int offset = null, int limit = null, long minChangeVersion = null, long maxChangeVersion = null, bool totalCount = null, int curriculumUsedDescriptorId = null, bool useSnapshot = null)
...
namespace Example
{
    public class GetCurriculumUsedDescriptorsExample
    {
        public static void Main()
        {
            ...
            {
                // Retrieves specific resources using the resource's property values (using the \"Get\" pattern).
                List<EdFiCurriculumUsedDescriptor> result = apiInstance.GetCurriculumUsedDescriptors(offset, limit, minChangeVersion, maxChangeVersion, totalCount, curriculumUsedDescriptorId, useSnapshot);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
...
{
    // Retrieves specific resources using the resource's property values (using the \"Get\" pattern).
    ApiResponse<List<EdFiCurriculumUsedDescriptor>> response = apiInstance.GetCurriculumUsedDescriptorsWithHttpInfo(offset, limit, minChangeVersion, maxChangeVersion, totalCount, curriculumUsedDescriptorId, useSnapshot);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
