# EdFi.OdsApi.Sdk.v71.Apis.All.SectionCharacteristicDescriptorsApi
...
> List&lt;EdFiSectionCharacteristicDescriptor&gt; GetSectionCharacteristicDescriptors (int offset = null, int limit = null, long minChangeVersion = null, long maxChangeVersion = null, bool totalCount = null, int sectionCharacteristicDescriptorId = null, bool useSnapshot = null)
...
namespace Example
{
    public class GetSectionCharacteristicDescriptorsExample
    {
        public static void Main()
        {
            ...
            {
                // Retrieves specific resources using the resource's property values (using the \"Get\" pattern).
                List<EdFiSectionCharacteristicDescriptor> result = apiInstance.GetSectionCharacteristicDescriptors(offset, limit, minChangeVersion, maxChangeVersion, totalCount, sectionCharacteristicDescriptorId, useSnapshot);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
...
{
    // Retrieves specific resources using the resource's property values (using the \"Get\" pattern).
    ApiResponse<List<EdFiSectionCharacteristicDescriptor>> response = apiInstance.GetSectionCharacteristicDescriptorsWithHttpInfo(offset, limit, minChangeVersion, maxChangeVersion, totalCount, sectionCharacteristicDescriptorId, useSnapshot);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
