# EdFi.OdsApi.Sdk.v71.Apis.All.AttemptStatusDescriptorsApi
...
> List&lt;EdFiAttemptStatusDescriptor&gt; GetAttemptStatusDescriptors (int offset = null, int limit = null, long minChangeVersion = null, long maxChangeVersion = null, bool totalCount = null, int attemptStatusDescriptorId = null, bool useSnapshot = null)
...
namespace Example
{
    public class GetAttemptStatusDescriptorsExample
    {
        public static void Main()
        {
            ...
            {
                // Retrieves specific resources using the resource's property values (using the \"Get\" pattern).
                List<EdFiAttemptStatusDescriptor> result = apiInstance.GetAttemptStatusDescriptors(offset, limit, minChangeVersion, maxChangeVersion, totalCount, attemptStatusDescriptorId, useSnapshot);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
...
{
    // Retrieves specific resources using the resource's property values (using the \"Get\" pattern).
    ApiResponse<List<EdFiAttemptStatusDescriptor>> response = apiInstance.GetAttemptStatusDescriptorsWithHttpInfo(offset, limit, minChangeVersion, maxChangeVersion, totalCount, attemptStatusDescriptorId, useSnapshot);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
