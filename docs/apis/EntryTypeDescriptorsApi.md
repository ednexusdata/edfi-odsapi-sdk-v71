# EdFi.OdsApi.Sdk.v71.Apis.All.EntryTypeDescriptorsApi
...
> List&lt;EdFiEntryTypeDescriptor&gt; GetEntryTypeDescriptors (int offset = null, int limit = null, long minChangeVersion = null, long maxChangeVersion = null, bool totalCount = null, int entryTypeDescriptorId = null, bool useSnapshot = null)
...
namespace Example
{
    public class GetEntryTypeDescriptorsExample
    {
        public static void Main()
        {
            ...
            {
                // Retrieves specific resources using the resource's property values (using the \"Get\" pattern).
                List<EdFiEntryTypeDescriptor> result = apiInstance.GetEntryTypeDescriptors(offset, limit, minChangeVersion, maxChangeVersion, totalCount, entryTypeDescriptorId, useSnapshot);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
...
{
    // Retrieves specific resources using the resource's property values (using the \"Get\" pattern).
    ApiResponse<List<EdFiEntryTypeDescriptor>> response = apiInstance.GetEntryTypeDescriptorsWithHttpInfo(offset, limit, minChangeVersion, maxChangeVersion, totalCount, entryTypeDescriptorId, useSnapshot);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
