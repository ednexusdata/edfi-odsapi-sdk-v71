# EdFi.OdsApi.Sdk.v71.Apis.All.BarrierToInternetAccessInResidenceDescriptorsApi
...
> List&lt;EdFiBarrierToInternetAccessInResidenceDescriptor&gt; GetBarrierToInternetAccessInResidenceDescriptors (int offset = null, int limit = null, long minChangeVersion = null, long maxChangeVersion = null, bool totalCount = null, int barrierToInternetAccessInResidenceDescriptorId = null, bool useSnapshot = null)
...
namespace Example
{
    public class GetBarrierToInternetAccessInResidenceDescriptorsExample
    {
        public static void Main()
        {
            ...
            {
                // Retrieves specific resources using the resource's property values (using the \"Get\" pattern).
                List<EdFiBarrierToInternetAccessInResidenceDescriptor> result = apiInstance.GetBarrierToInternetAccessInResidenceDescriptors(offset, limit, minChangeVersion, maxChangeVersion, totalCount, barrierToInternetAccessInResidenceDescriptorId, useSnapshot);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
...
{
    // Retrieves specific resources using the resource's property values (using the \"Get\" pattern).
    ApiResponse<List<EdFiBarrierToInternetAccessInResidenceDescriptor>> response = apiInstance.GetBarrierToInternetAccessInResidenceDescriptorsWithHttpInfo(offset, limit, minChangeVersion, maxChangeVersion, totalCount, barrierToInternetAccessInResidenceDescriptorId, useSnapshot);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
