# EdFi.OdsApi.Sdk.v71.Apis.All.StudentParticipationCodeDescriptorsApi
...
> List&lt;EdFiStudentParticipationCodeDescriptor&gt; GetStudentParticipationCodeDescriptors (int offset = null, int limit = null, long minChangeVersion = null, long maxChangeVersion = null, bool totalCount = null, int studentParticipationCodeDescriptorId = null, bool useSnapshot = null)
...
namespace Example
{
    public class GetStudentParticipationCodeDescriptorsExample
    {
        public static void Main()
        {
            ...
            {
                // Retrieves specific resources using the resource's property values (using the \"Get\" pattern).
                List<EdFiStudentParticipationCodeDescriptor> result = apiInstance.GetStudentParticipationCodeDescriptors(offset, limit, minChangeVersion, maxChangeVersion, totalCount, studentParticipationCodeDescriptorId, useSnapshot);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
...
{
    // Retrieves specific resources using the resource's property values (using the \"Get\" pattern).
    ApiResponse<List<EdFiStudentParticipationCodeDescriptor>> response = apiInstance.GetStudentParticipationCodeDescriptorsWithHttpInfo(offset, limit, minChangeVersion, maxChangeVersion, totalCount, studentParticipationCodeDescriptorId, useSnapshot);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
