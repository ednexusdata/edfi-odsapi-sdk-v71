...
namespace EdFi.OdsApi.Sdk.v71.Models.All
{
    ...
    public partial class EdFiProgramCharacteristicDescriptor : IValidatableObject
    {
        ...
        public EdFiProgramCharacteristicDescriptor(string id = default, int programCharacteristicDescriptorId = default, string codeValue = default, string description = default, DateOnly? effectiveBeginDate = default, DateOnly? effectiveEndDate = default, string varNamespace = default, string shortDescription = default, string etag = default, DateTime lastModifiedDate = default)
        {
