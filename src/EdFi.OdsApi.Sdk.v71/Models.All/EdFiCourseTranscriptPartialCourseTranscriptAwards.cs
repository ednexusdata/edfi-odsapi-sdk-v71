...
namespace EdFi.OdsApi.Sdk.v71.Models.All
{
    ...
    public partial class EdFiCourseTranscriptPartialCourseTranscriptAwards : IValidatableObject
    {
        ...
        IEnumerable<ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            {
                yield return new ValidationResult("Invalid value for LetterGradeEarned, length must be greater than 1.", new [] { "LetterGradeEarned" });
            }
            ...
            {
                yield return new ValidationResult("Invalid value for NumericGradeEarned, length must be greater than 1.", new [] { "NumericGradeEarned" });
            }
