...
namespace EdFi.OdsApi.Sdk.v71.Models.All
{
    ...
    public partial class EdFiAssessmentPerformanceLevel : IValidatableObject
    {
        ...
        IEnumerable<ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            {
                yield return new ValidationResult("Invalid value for MaximumScore, length must be greater than 1.", new [] { "MaximumScore" });
            }
            ...
            {
                yield return new ValidationResult("Invalid value for MinimumScore, length must be greater than 1.", new [] { "MinimumScore" });
            }
            ...
            {
                yield return new ValidationResult("Invalid value for PerformanceLevelIndicatorName, length must be greater than 1.", new [] { "PerformanceLevelIndicatorName" });
            }
