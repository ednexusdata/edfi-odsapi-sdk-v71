...
namespace EdFi.OdsApi.Sdk.v71.Models.All
{
    ...
    public partial class EdFiRatingLevelDescriptor : IValidatableObject
    {
        ...
        public EdFiRatingLevelDescriptor(string id = default, int ratingLevelDescriptorId = default, string codeValue = default, string description = default, DateOnly? effectiveBeginDate = default, DateOnly? effectiveEndDate = default, string varNamespace = default, string shortDescription = default, string etag = default, DateTime lastModifiedDate = default)
        {
            ...
            this.Id = id;
            this.RatingLevelDescriptorId = ratingLevelDescriptorId;
        ...
        [DataMember(Name = "ratingLevelDescriptorId", EmitDefaultValue = false)]
