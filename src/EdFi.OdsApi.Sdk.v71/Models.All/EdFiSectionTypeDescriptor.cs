...
namespace EdFi.OdsApi.Sdk.v71.Models.All
{
    ...
    public partial class EdFiSectionTypeDescriptor : IValidatableObject
    {
        ...
        public EdFiSectionTypeDescriptor(string id = default, int sectionTypeDescriptorId = default, string codeValue = default, string description = default, DateOnly? effectiveBeginDate = default, DateOnly? effectiveEndDate = default, string varNamespace = default, string shortDescription = default, string etag = default, DateTime lastModifiedDate = default)
        {
            ...
            this.Id = id;
            this.SectionTypeDescriptorId = sectionTypeDescriptorId;
        ...
        [DataMember(Name = "sectionTypeDescriptorId", EmitDefaultValue = false)]
