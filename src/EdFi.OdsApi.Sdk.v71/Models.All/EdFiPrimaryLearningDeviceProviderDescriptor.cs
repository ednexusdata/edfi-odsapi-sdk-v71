...
namespace EdFi.OdsApi.Sdk.v71.Models.All
{
    ...
    public partial class EdFiPrimaryLearningDeviceProviderDescriptor : IValidatableObject
    {
        ...
        public EdFiPrimaryLearningDeviceProviderDescriptor(string id = default, int primaryLearningDeviceProviderDescriptorId = default, string codeValue = default, string description = default, DateOnly? effectiveBeginDate = default, DateOnly? effectiveEndDate = default, string varNamespace = default, string shortDescription = default, string etag = default, DateTime lastModifiedDate = default)
        {
