...
namespace EdFi.OdsApi.Sdk.v71.Models.All
{
    ...
    public partial class EdFiLocaleDescriptor : IValidatableObject
    {
        ...
        public EdFiLocaleDescriptor(string id = default, int localeDescriptorId = default, string codeValue = default, string description = default, DateOnly? effectiveBeginDate = default, DateOnly? effectiveEndDate = default, string varNamespace = default, string shortDescription = default, string etag = default, DateTime lastModifiedDate = default)
        {
