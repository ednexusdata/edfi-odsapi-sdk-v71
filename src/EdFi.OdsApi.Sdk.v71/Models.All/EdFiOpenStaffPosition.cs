...
namespace EdFi.OdsApi.Sdk.v71.Models.All
{
    ...
    public partial class EdFiOpenStaffPosition : IValidatableObject
    {
        ...
        IEnumerable<ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            {
                yield return new ValidationResult("Invalid value for RequisitionNumber, length must be greater than 1.", new [] { "RequisitionNumber" });
            }
            ...
            {
                yield return new ValidationResult("Invalid value for PositionTitle, length must be greater than 1.", new [] { "PositionTitle" });
            }
