...
namespace EdFi.OdsApi.Sdk.v71.Models.All
{
    ...
    public partial class EdFiCourseLevelCharacteristicDescriptor : IValidatableObject
    {
        ...
        public EdFiCourseLevelCharacteristicDescriptor(string id = default, int courseLevelCharacteristicDescriptorId = default, string codeValue = default, string description = default, DateOnly? effectiveBeginDate = default, DateOnly? effectiveEndDate = default, string varNamespace = default, string shortDescription = default, string etag = default, DateTime lastModifiedDate = default)
        {
