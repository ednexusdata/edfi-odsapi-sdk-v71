...
namespace EdFi.OdsApi.Sdk.v71.Models.All
{
    ...
    public partial class EdFiStudentEducationOrganizationAssociationStudentIndicator : IValidatableObject
    {
        ...
        IEnumerable<ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            {
                yield return new ValidationResult("Invalid value for IndicatorName, length must be greater than 1.", new [] { "IndicatorName" });
            }
            ...
            {
                yield return new ValidationResult("Invalid value for DesignatedBy, length must be greater than 1.", new [] { "DesignatedBy" });
            }
            ...
            {
                yield return new ValidationResult("Invalid value for IndicatorGroup, length must be greater than 1.", new [] { "IndicatorGroup" });
            }
