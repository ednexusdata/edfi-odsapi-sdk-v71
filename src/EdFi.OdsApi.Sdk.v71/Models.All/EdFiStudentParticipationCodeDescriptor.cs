...
namespace EdFi.OdsApi.Sdk.v71.Models.All
{
    ...
    public partial class EdFiStudentParticipationCodeDescriptor : IValidatableObject
    {
        ...
        public EdFiStudentParticipationCodeDescriptor(string id = default, int studentParticipationCodeDescriptorId = default, string codeValue = default, string description = default, DateOnly? effectiveBeginDate = default, DateOnly? effectiveEndDate = default, string varNamespace = default, string shortDescription = default, string etag = default, DateTime lastModifiedDate = default)
        {
