...
namespace EdFi.OdsApi.Sdk.v71.Models.All
{
    ...
    public partial class EdFiSurveyQuestionResponseSurveyQuestionMatrixElementResponse : IValidatableObject
    {
        ...
        IEnumerable<ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            {
                yield return new ValidationResult("Invalid value for MatrixElement, length must be greater than 1.", new [] { "MatrixElement" });
            }
            ...
            {
                yield return new ValidationResult("Invalid value for TextResponse, length must be greater than 1.", new [] { "TextResponse" });
            }
