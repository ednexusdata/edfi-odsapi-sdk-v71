...
namespace EdFi.OdsApi.Sdk.v71.Models.All
{
    ...
    public partial class EdFiCourseTranscript : IValidatableObject
    {
        ...
        IEnumerable<ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            {
                yield return new ValidationResult("Invalid value for AlternativeCourseTitle, length must be greater than 1.", new [] { "AlternativeCourseTitle" });
            }
            ...
            {
                yield return new ValidationResult("Invalid value for AssigningOrganizationIdentificationCode, length must be greater than 1.", new [] { "AssigningOrganizationIdentificationCode" });
            }
            ...
            {
                yield return new ValidationResult("Invalid value for CourseTitle, length must be greater than 1.", new [] { "CourseTitle" });
            }
            ...
            {
                yield return new ValidationResult("Invalid value for ExternalEducationOrganizationNameOfInstitution, length must be greater than 1.", new [] { "ExternalEducationOrganizationNameOfInstitution" });
            }
            ...
            {
                yield return new ValidationResult("Invalid value for FinalLetterGradeEarned, length must be greater than 1.", new [] { "FinalLetterGradeEarned" });
            }
