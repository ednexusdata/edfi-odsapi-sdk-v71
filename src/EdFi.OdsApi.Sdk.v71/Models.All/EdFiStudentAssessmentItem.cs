...
namespace EdFi.OdsApi.Sdk.v71.Models.All
{
    ...
    public partial class EdFiStudentAssessmentItem : IValidatableObject
    {
        ...
        IEnumerable<ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            {
                yield return new ValidationResult("Invalid value for AssessmentResponse, length must be greater than 1.", new [] { "AssessmentResponse" });
            }
            ...
            {
                yield return new ValidationResult("Invalid value for DescriptiveFeedback, length must be greater than 1.", new [] { "DescriptiveFeedback" });
            }
