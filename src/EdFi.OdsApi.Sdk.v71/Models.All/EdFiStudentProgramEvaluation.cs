...
namespace EdFi.OdsApi.Sdk.v71.Models.All
{
    ...
    public partial class EdFiStudentProgramEvaluation : IValidatableObject
    {
        ...
        IEnumerable<ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            // SummaryEvaluationComment (string) minLength
            if (this.SummaryEvaluationComment != null && this.SummaryEvaluationComment.Length < 1)
            {
                yield return new ValidationResult("Invalid value for SummaryEvaluationComment, length must be greater than 1.", new [] { "SummaryEvaluationComment" });
            }
