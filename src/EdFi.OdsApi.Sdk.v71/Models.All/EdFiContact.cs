...
namespace EdFi.OdsApi.Sdk.v71.Models.All
{
    ...
    public partial class EdFiContact : IValidatableObject
    {
        ...
        IEnumerable<ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            {
                yield return new ValidationResult("Invalid value for ContactUniqueId, length must be greater than 1.", new [] { "ContactUniqueId" });
            }
            ...
            {
                yield return new ValidationResult("Invalid value for LastSurname, length must be greater than 1.", new [] { "LastSurname" });
            }
            ...
            {
                yield return new ValidationResult("Invalid value for GenerationCodeSuffix, length must be greater than 1.", new [] { "GenerationCodeSuffix" });
            }
            ...
            {
                yield return new ValidationResult("Invalid value for LoginId, length must be greater than 1.", new [] { "LoginId" });
            }
            ...
            {
                yield return new ValidationResult("Invalid value for MaidenName, length must be greater than 1.", new [] { "MaidenName" });
            }
            ...
            {
                yield return new ValidationResult("Invalid value for MiddleName, length must be greater than 1.", new [] { "MiddleName" });
            }
            ...
            {
                yield return new ValidationResult("Invalid value for PersonalTitlePrefix, length must be greater than 1.", new [] { "PersonalTitlePrefix" });
            }
            ...
            {
                yield return new ValidationResult("Invalid value for PreferredFirstName, length must be greater than 1.", new [] { "PreferredFirstName" });
            }
            ...
            {
                yield return new ValidationResult("Invalid value for PreferredLastSurname, length must be greater than 1.", new [] { "PreferredLastSurname" });
            }
