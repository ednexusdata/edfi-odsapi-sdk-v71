...
namespace EdFi.OdsApi.Sdk.v71.Models.All
{
    ...
    public partial class EdFiStudentAcademicRecordRecognition : IValidatableObject
    {
        ...
        IEnumerable<ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            {
                yield return new ValidationResult("Invalid value for AchievementCategorySystem, length must be greater than 1.", new [] { "AchievementCategorySystem" });
            }
            ...
            {
                yield return new ValidationResult("Invalid value for AchievementTitle, length must be greater than 1.", new [] { "AchievementTitle" });
            }
            ...
            {
                yield return new ValidationResult("Invalid value for Criteria, length must be greater than 1.", new [] { "Criteria" });
            }
            ...
            {
                yield return new ValidationResult("Invalid value for EvidenceStatement, length must be greater than 1.", new [] { "EvidenceStatement" });
            }
            ...
            {
                yield return new ValidationResult("Invalid value for RecognitionDescription, length must be greater than 1.", new [] { "RecognitionDescription" });
            }
