...
namespace EdFi.OdsApi.Sdk.v71.Models.All
{
    ...
    public partial class EdFiProgramEvaluationTypeDescriptor : IValidatableObject
    {
        ...
        public EdFiProgramEvaluationTypeDescriptor(string id = default, int programEvaluationTypeDescriptorId = default, string codeValue = default, string description = default, DateOnly? effectiveBeginDate = default, DateOnly? effectiveEndDate = default, string varNamespace = default, string shortDescription = default, string etag = default, DateTime lastModifiedDate = default)
        {
            ...
            this.Id = id;
            this.ProgramEvaluationTypeDescriptorId = programEvaluationTypeDescriptorId;
        ...
        [DataMember(Name = "programEvaluationTypeDescriptorId", EmitDefaultValue = false)]
