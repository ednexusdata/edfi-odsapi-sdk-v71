...
namespace EdFi.OdsApi.Sdk.v71.Models.All
{
    ...
    public partial class EdFiPostSecondaryInstitution : IValidatableObject
    {
        ...
        IEnumerable<ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            {
                yield return new ValidationResult("Invalid value for NameOfInstitution, length must be greater than 1.", new [] { "NameOfInstitution" });
            }
            ...
            {
                yield return new ValidationResult("Invalid value for ShortNameOfInstitution, length must be greater than 1.", new [] { "ShortNameOfInstitution" });
            }
