...
namespace EdFi.OdsApi.Sdk.v71.Models.All
{
    ...
    public partial class EdFiEducationContent : IValidatableObject
    {
        ...
        IEnumerable<ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            {
                yield return new ValidationResult("Invalid value for ContentIdentifier, length must be greater than 1.", new [] { "ContentIdentifier" });
            }
            ...
            {
                yield return new ValidationResult("Invalid value for Publisher, length must be greater than 1.", new [] { "Publisher" });
            }
