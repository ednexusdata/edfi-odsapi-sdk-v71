...
namespace EdFi.OdsApi.Sdk.v71.Models.All
{
    ...
    public partial class EdFiDisciplineIncident : IValidatableObject
    {
        ...
        IEnumerable<ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            {
                yield return new ValidationResult("Invalid value for IncidentIdentifier, length must be greater than 1.", new [] { "IncidentIdentifier" });
            }
            ...
            {
                yield return new ValidationResult("Invalid value for CaseNumber, length must be greater than 1.", new [] { "CaseNumber" });
            }
            ...
            {
                yield return new ValidationResult("Invalid value for IncidentDescription, length must be greater than 1.", new [] { "IncidentDescription" });
            }
            ...
            {
                yield return new ValidationResult("Invalid value for ReporterName, length must be greater than 1.", new [] { "ReporterName" });
            }
