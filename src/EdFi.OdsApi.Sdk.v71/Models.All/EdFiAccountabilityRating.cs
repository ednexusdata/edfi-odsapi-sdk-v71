...
namespace EdFi.OdsApi.Sdk.v71.Models.All
{
    ...
    public partial class EdFiAccountabilityRating : IValidatableObject
    {
        ...
        IEnumerable<ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            {
                yield return new ValidationResult("Invalid value for Rating, length must be greater than 1.", new [] { "Rating" });
            }
            ...
            {
                yield return new ValidationResult("Invalid value for RatingOrganization, length must be greater than 1.", new [] { "RatingOrganization" });
            }
            ...
            {
                yield return new ValidationResult("Invalid value for RatingProgram, length must be greater than 1.", new [] { "RatingProgram" });
            }
