...
namespace EdFi.OdsApi.Sdk.v71.Models.All
{
    ...
    public partial class EdFiCohort : IValidatableObject
    {
        ...
        IEnumerable<ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            {
                yield return new ValidationResult("Invalid value for CohortIdentifier, length must be greater than 1.", new [] { "CohortIdentifier" });
            }
            ...
            {
                yield return new ValidationResult("Invalid value for CohortDescription, length must be greater than 1.", new [] { "CohortDescription" });
            }
