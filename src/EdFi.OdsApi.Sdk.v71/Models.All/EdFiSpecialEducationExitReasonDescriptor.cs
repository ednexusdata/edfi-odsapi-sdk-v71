...
namespace EdFi.OdsApi.Sdk.v71.Models.All
{
    ...
    public partial class EdFiSpecialEducationExitReasonDescriptor : IValidatableObject
    {
        ...
        public EdFiSpecialEducationExitReasonDescriptor(string id = default, int specialEducationExitReasonDescriptorId = default, string codeValue = default, string description = default, DateOnly? effectiveBeginDate = default, DateOnly? effectiveEndDate = default, string varNamespace = default, string shortDescription = default, string etag = default, DateTime lastModifiedDate = default)
        {
            ...
            this.Id = id;
            this.SpecialEducationExitReasonDescriptorId = specialEducationExitReasonDescriptorId;
        ...
        [DataMember(Name = "specialEducationExitReasonDescriptorId", EmitDefaultValue = false)]
