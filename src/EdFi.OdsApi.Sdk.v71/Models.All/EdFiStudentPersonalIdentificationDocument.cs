...
namespace EdFi.OdsApi.Sdk.v71.Models.All
{
    ...
    public partial class EdFiStudentPersonalIdentificationDocument : IValidatableObject
    {
        ...
        IEnumerable<ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            {
                yield return new ValidationResult("Invalid value for IssuerDocumentIdentificationCode, length must be greater than 1.", new [] { "IssuerDocumentIdentificationCode" });
            }
