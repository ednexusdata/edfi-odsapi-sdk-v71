...
namespace EdFi.OdsApi.Sdk.v71.Models.All
{
    ...
    public partial class EdFiBellSchedule : IValidatableObject
    {
        ...
        IEnumerable<ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            {
                yield return new ValidationResult("Invalid value for BellScheduleName, length must be greater than 1.", new [] { "BellScheduleName" });
            }
            ...
            {
                yield return new ValidationResult("Invalid value for AlternateDayName, length must be greater than 1.", new [] { "AlternateDayName" });
            }
