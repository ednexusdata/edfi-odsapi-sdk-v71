...
namespace EdFi.OdsApi.Sdk.v71.Models.All
{
    ...
    public partial class TrackedChangesEdFiSurveySectionResponseStaffTargetAssociationKey : IValidatableObject
    {
        ...
        IEnumerable<ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            {
                yield return new ValidationResult("Invalid value for SurveyIdentifier, length must be greater than 1.", new [] { "SurveyIdentifier" });
            }
            ...
            {
                yield return new ValidationResult("Invalid value for SurveyResponseIdentifier, length must be greater than 1.", new [] { "SurveyResponseIdentifier" });
            }
            ...
            {
                yield return new ValidationResult("Invalid value for SurveySectionTitle, length must be greater than 1.", new [] { "SurveySectionTitle" });
            }
