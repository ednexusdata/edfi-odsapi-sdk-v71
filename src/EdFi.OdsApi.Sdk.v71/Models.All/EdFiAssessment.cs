...
namespace EdFi.OdsApi.Sdk.v71.Models.All
{
    ...
    public partial class EdFiAssessment : IValidatableObject
    {
        ...
        IEnumerable<ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            {
                yield return new ValidationResult("Invalid value for AssessmentIdentifier, length must be greater than 1.", new [] { "AssessmentIdentifier" });
            }
            ...
            {
                yield return new ValidationResult("Invalid value for AssessmentTitle, length must be greater than 1.", new [] { "AssessmentTitle" });
            }
            ...
            {
                yield return new ValidationResult("Invalid value for AssessmentFamily, length must be greater than 1.", new [] { "AssessmentFamily" });
            }
            ...
            {
                yield return new ValidationResult("Invalid value for AssessmentForm, length must be greater than 1.", new [] { "AssessmentForm" });
            }
