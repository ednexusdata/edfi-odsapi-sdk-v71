...
namespace EdFi.OdsApi.Sdk.v71.Models.All
{
    ...
    public partial class EdFiTeachingCredentialBasisDescriptor : IValidatableObject
    {
        ...
        public EdFiTeachingCredentialBasisDescriptor(string id = default, int teachingCredentialBasisDescriptorId = default, string codeValue = default, string description = default, DateOnly? effectiveBeginDate = default, DateOnly? effectiveEndDate = default, string varNamespace = default, string shortDescription = default, string etag = default, DateTime lastModifiedDate = default)
        {
