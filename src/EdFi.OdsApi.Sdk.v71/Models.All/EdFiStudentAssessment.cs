...
namespace EdFi.OdsApi.Sdk.v71.Models.All
{
    ...
    public partial class EdFiStudentAssessment : IValidatableObject
    {
        ...
        IEnumerable<ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            {
                yield return new ValidationResult("Invalid value for StudentAssessmentIdentifier, length must be greater than 1.", new [] { "StudentAssessmentIdentifier" });
            }
            ...
            {
                yield return new ValidationResult("Invalid value for EventDescription, length must be greater than 1.", new [] { "EventDescription" });
            }
            ...
            {
                yield return new ValidationResult("Invalid value for ReportedSchoolIdentifier, length must be greater than 1.", new [] { "ReportedSchoolIdentifier" });
            }
