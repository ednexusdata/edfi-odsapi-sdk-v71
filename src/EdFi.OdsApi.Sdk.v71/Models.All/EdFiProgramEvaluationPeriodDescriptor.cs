...
namespace EdFi.OdsApi.Sdk.v71.Models.All
{
    ...
    public partial class EdFiProgramEvaluationPeriodDescriptor : IValidatableObject
    {
        ...
        public EdFiProgramEvaluationPeriodDescriptor(string id = default, int programEvaluationPeriodDescriptorId = default, string codeValue = default, string description = default, DateOnly? effectiveBeginDate = default, DateOnly? effectiveEndDate = default, string varNamespace = default, string shortDescription = default, string etag = default, DateTime lastModifiedDate = default)
        {
            ...
            this.Id = id;
            this.ProgramEvaluationPeriodDescriptorId = programEvaluationPeriodDescriptorId;
        ...
        [DataMember(Name = "programEvaluationPeriodDescriptorId", EmitDefaultValue = false)]
