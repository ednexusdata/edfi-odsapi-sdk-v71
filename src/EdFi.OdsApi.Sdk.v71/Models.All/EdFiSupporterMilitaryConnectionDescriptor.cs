...
namespace EdFi.OdsApi.Sdk.v71.Models.All
{
    ...
    public partial class EdFiSupporterMilitaryConnectionDescriptor : IValidatableObject
    {
        ...
        public EdFiSupporterMilitaryConnectionDescriptor(string id = default, int supporterMilitaryConnectionDescriptorId = default, string codeValue = default, string description = default, DateOnly? effectiveBeginDate = default, DateOnly? effectiveEndDate = default, string varNamespace = default, string shortDescription = default, string etag = default, DateTime lastModifiedDate = default)
        {
            ...
            this.Id = id;
            this.SupporterMilitaryConnectionDescriptorId = supporterMilitaryConnectionDescriptorId;
        ...
        [DataMember(Name = "supporterMilitaryConnectionDescriptorId", EmitDefaultValue = false)]
