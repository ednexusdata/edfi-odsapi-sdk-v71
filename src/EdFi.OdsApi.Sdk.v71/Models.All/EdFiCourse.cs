...
namespace EdFi.OdsApi.Sdk.v71.Models.All
{
    ...
    public partial class EdFiCourse : IValidatableObject
    {
        ...
        IEnumerable<ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            {
                yield return new ValidationResult("Invalid value for CourseCode, length must be greater than 1.", new [] { "CourseCode" });
            }
            ...
            {
                yield return new ValidationResult("Invalid value for CourseDescription, length must be greater than 1.", new [] { "CourseDescription" });
            }
