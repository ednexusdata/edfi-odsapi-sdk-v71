...
namespace EdFi.OdsApi.Sdk.v71.Models.All
{
    ...
    public partial class EdFiContactAddress : IValidatableObject
    {
        ...
        IEnumerable<ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            {
                yield return new ValidationResult("Invalid value for StreetNumberName, length must be greater than 1.", new [] { "StreetNumberName" });
            }
            ...
            {
                yield return new ValidationResult("Invalid value for ApartmentRoomSuiteNumber, length must be greater than 1.", new [] { "ApartmentRoomSuiteNumber" });
            }
            ...
            {
                yield return new ValidationResult("Invalid value for BuildingSiteNumber, length must be greater than 1.", new [] { "BuildingSiteNumber" });
            }
            ...
            {
                yield return new ValidationResult("Invalid value for CongressionalDistrict, length must be greater than 1.", new [] { "CongressionalDistrict" });
            }
            ...
            {
                yield return new ValidationResult("Invalid value for Latitude, length must be greater than 1.", new [] { "Latitude" });
            }
            ...
            {
                yield return new ValidationResult("Invalid value for Longitude, length must be greater than 1.", new [] { "Longitude" });
            }
            ...
            {
                yield return new ValidationResult("Invalid value for NameOfCounty, length must be greater than 1.", new [] { "NameOfCounty" });
            }
