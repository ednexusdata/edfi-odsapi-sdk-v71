...
namespace EdFi.OdsApi.Sdk.v71.Models.All
{
    ...
    public partial class EdFiAssessmentItemPossibleResponse : IValidatableObject
    {
        ...
        IEnumerable<ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            {
                yield return new ValidationResult("Invalid value for ResponseValue, length must be greater than 1.", new [] { "ResponseValue" });
            }
            ...
            {
                yield return new ValidationResult("Invalid value for ResponseDescription, length must be greater than 1.", new [] { "ResponseDescription" });
            }
