...
namespace EdFi.OdsApi.Sdk.v71.Models.All
{
    ...
    public partial class EdFiLearningStandard : IValidatableObject
    {
        ...
        IEnumerable<ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            {
                yield return new ValidationResult("Invalid value for LearningStandardId, length must be greater than 1.", new [] { "LearningStandardId" });
            }
            ...
            {
                yield return new ValidationResult("Invalid value for LearningStandardItemCode, length must be greater than 1.", new [] { "LearningStandardItemCode" });
            }
            ...
            {
                yield return new ValidationResult("Invalid value for SuccessCriteria, length must be greater than 1.", new [] { "SuccessCriteria" });
            }
