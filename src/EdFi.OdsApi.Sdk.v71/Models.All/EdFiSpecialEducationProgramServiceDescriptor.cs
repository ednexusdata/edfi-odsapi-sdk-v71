...
namespace EdFi.OdsApi.Sdk.v71.Models.All
{
    ...
    public partial class EdFiSpecialEducationProgramServiceDescriptor : IValidatableObject
    {
        ...
        public EdFiSpecialEducationProgramServiceDescriptor(string id = default, int specialEducationProgramServiceDescriptorId = default, string codeValue = default, string description = default, DateOnly? effectiveBeginDate = default, DateOnly? effectiveEndDate = default, string varNamespace = default, string shortDescription = default, string etag = default, DateTime lastModifiedDate = default)
        {
