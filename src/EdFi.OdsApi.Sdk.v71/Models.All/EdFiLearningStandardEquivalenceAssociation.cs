...
namespace EdFi.OdsApi.Sdk.v71.Models.All
{
    ...
    public partial class EdFiLearningStandardEquivalenceAssociation : IValidatableObject
    {
        ...
        IEnumerable<ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            {
                yield return new ValidationResult("Invalid value for LearningStandardEquivalenceStrengthDescription, length must be greater than 1.", new [] { "LearningStandardEquivalenceStrengthDescription" });
            }
