...
namespace EdFi.OdsApi.Sdk.v71.Apis.All
{
    ...
    /// </summary>
    public interface IDeleteSchoolByIdApiResponse : EdFi.OdsApi.Sdk.v71.Client.IApiResponse
    {
        /// <summary>
    ...
    /// </summary>
    public interface IDeletesSchoolsApiResponse : EdFi.OdsApi.Sdk.v71.Client.IApiResponse, IOk<List<TrackedChangesEdFiSchoolDelete>?>
    {
        /// <summary>
    ...
    /// </summary>
    public interface IGetSchoolsApiResponse : EdFi.OdsApi.Sdk.v71.Client.IApiResponse, IOk<List<EdFiSchool>?>
    {
        /// <summary>
        /// Returns true if the response is 200 Ok
        /// </summary>
    ...
    /// </summary>
    public interface IGetSchoolsByIdApiResponse : EdFi.OdsApi.Sdk.v71.Client.IApiResponse, IOk<EdFi.OdsApi.Sdk.v71.Models.All.EdFiSchool?>
    {
        /// <summary>
        /// Returns true if the response is 200 Ok
        /// </summary>
    ...
    /// </summary>
    public interface IKeyChangesSchoolsApiResponse : EdFi.OdsApi.Sdk.v71.Client.IApiResponse, IOk<List<TrackedChangesEdFiSchoolKeyChange>?>
    {
        /// <summary>
        /// Returns true if the response is 200 Ok
        /// </summary>
    ...
    /// </summary>
    public interface IPostSchoolApiResponse : EdFi.OdsApi.Sdk.v71.Client.IApiResponse
    {
        /// <summary>
        /// Returns true if the response is 200 Ok
        /// </summary>
    ...
    /// </summary>
    public interface IPutSchoolApiResponse : EdFi.OdsApi.Sdk.v71.Client.IApiResponse
    {
        /// <summary>
        /// Returns true if the response is 204 NoContent
        /// </summary>
    ...
    public sealed partial class SchoolsApi : ISchoolsApi
    {
        ...
        /// </summary>
        public partial class DeleteSchoolByIdApiResponse : EdFi.OdsApi.Sdk.v71.Client.ApiResponse, IDeleteSchoolByIdApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
        ...
        /// </summary>
        public partial class DeletesSchoolsApiResponse : EdFi.OdsApi.Sdk.v71.Client.ApiResponse, IDeletesSchoolsApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
        ...
        public async Task<IGetSchoolsApiResponse?> GetSchoolsOrDefaultAsync(Option<int> offset = default, Option<int> limit = default, Option<long> minChangeVersion = default, Option<long> maxChangeVersion = default, Option<bool> totalCount = default, Option<long> schoolId = default, Option<long> localEducationAgencyId = default, Option<int> charterApprovalSchoolYear = default, Option<string> administrativeFundingControlDescriptor = default, Option<string> charterApprovalAgencyTypeDescriptor = default, Option<string> charterStatusDescriptor = default, Option<string> internetAccessDescriptor = default, Option<string> magnetSpecialProgramEmphasisSchoolDescriptor = default, Option<string> schoolTypeDescriptor = default, Option<string> titleIPartASchoolDesignationDescriptor = default, Option<bool> useSnapshot = default, System.Threading.CancellationToken cancellationToken = default)
        {
            try
            {
                return await GetSchoolsAsync(offset, limit, minChangeVersion, maxChangeVersion, totalCount, schoolId, localEducationAgencyId, charterApprovalSchoolYear, administrativeFundingControlDescriptor, charterApprovalAgencyTypeDescriptor, charterStatusDescriptor, internetAccessDescriptor, magnetSpecialProgramEmphasisSchoolDescriptor, schoolTypeDescriptor, titleIPartASchoolDesignationDescriptor, useSnapshot, cancellationToken).ConfigureAwait(false);
            }
            catch (Exception)
            {
                return null;
        ...
        /// </summary>
        public partial class GetSchoolsApiResponse : EdFi.OdsApi.Sdk.v71.Client.ApiResponse, IGetSchoolsApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
        ...
        /// </summary>
        public partial class GetSchoolsByIdApiResponse : EdFi.OdsApi.Sdk.v71.Client.ApiResponse, IGetSchoolsByIdApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
            ...
            /// </summary>
            /// <returns></returns>
            public EdFi.OdsApi.Sdk.v71.Models.All.EdFiSchool? Ok()
            {
                // This logic may be modified with the AsModel.mustache template
                return IsOk
                    ? System.Text.Json.JsonSerializer.Deserialize<EdFi.OdsApi.Sdk.v71.Models.All.EdFiSchool>(RawContent, _jsonSerializerOptions)
                    : null;
            }
            ...
            /// <param name="result"></param>
            /// <returns></returns>
            public bool TryOk([NotNullWhen(true)]out EdFi.OdsApi.Sdk.v71.Models.All.EdFiSchool? result)
            {
                result = null;
        ...
        /// </summary>
        public partial class KeyChangesSchoolsApiResponse : EdFi.OdsApi.Sdk.v71.Client.ApiResponse, IKeyChangesSchoolsApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
        ...
        /// </summary>
        public partial class PostSchoolApiResponse : EdFi.OdsApi.Sdk.v71.Client.ApiResponse, IPostSchoolApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
        ...
        /// </summary>
        public partial class PutSchoolApiResponse : EdFi.OdsApi.Sdk.v71.Client.ApiResponse, IPutSchoolApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
